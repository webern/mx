...
group_class_name = "NormalTypeNormalDotGroup"

members = []

#sample code
members << Member.new( "myNormalType", "normal-type", "required", "NormalType" )
members << Member.new( "myNormalDotSet", "normal-dot", "collection", "NormalDot" )
