...
group_class_name = "CueNoteGroup"

members = []

#sample code
members << Member.new( "myCue", "cue", "required", "Cue" )
members << Member.new( "myFullNoteGroup", "TODO fix this", "required", "FullNoteGroup" )
members << Member.new( "myDuration", "duration", "required", "Duration" )
