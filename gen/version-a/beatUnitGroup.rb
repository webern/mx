...
group_class_name = "BeatUnitGroup"

members = []

#sample code
members << Member.new( "myBeatUnit", "beat-unit", "required", "BeatUnit" )
members << Member.new( "myBeatUnitDotSet", "beat-unit-dot", "collection", "BeatUnitDot" )
