...
group_class_name = "GraceNoteGroup"

members = []

#sample code
members << Member.new( "myGrace", "grace", "required", "Grace" )
members << Member.new( "myFullNoteGroup", "", "required", "FullNoteGroup" )
members << Member.new( "myTieSet", "tie", "collection", "Tie" )
