...
group_class_name = "ElisionSyllabicTextGroup"

members = []

#sample code
members << Member.new( "myElisionSyllabicGroup", "", "optional", "ElisionSyllabicGroup" )
members << Member.new( "myText", "text", "required", "Text" )
