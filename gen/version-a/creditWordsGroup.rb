...
group_class_name = "CreditWordsGroup"

members = []

#sample code
members << Member.new( "myLinkSet", "link", "collection", "Link" )
members << Member.new( "myBookmarkSet", "bookmark", "collection", "Bookmark" )
members << Member.new( "myCreditWords", "credit-words", "required", "CreditWords" )
