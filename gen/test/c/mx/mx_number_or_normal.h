...
#ifndef MX_NUMBER_OR_NORMAL_H
#define MX_NUMBER_OR_NORMAL_H
 ...
 */
typedef enum {
    MX_NUMBER_OR_NORMAL_KIND_DECIMAL = 0,
    MX_NUMBER_OR_NORMAL_KIND_NORMAL = 1
