...
group_class_name = "EditorialVoiceDirectionGroup"

members = []

#sample code
members << Member.new( "myFootnote", "footnote", "optional", "Footnote" )
members << Member.new( "myLevel", "level", "optional", "Level" )
members << Member.new( "myVoice", "voice", "optional", "Voice" )
