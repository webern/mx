...
group_class_name = "EditorialGroup"

members = []

#sample code
members << Member.new( "myFootnote", "display-step", "optional", "DisplayStep" )
members << Member.new( "myLevel", "display-step", "required", "DisplayStep" )
