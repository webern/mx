...
class LayoutData
{
  public:
    ...
    inline explicit LayoutData(bool inNewSystem, bool inNewPage = false)
        : system{inNewSystem ? Bool::yes : Bool::unspecified}, page{inNewPage ? Bool::yes : Bool::unspecified}
    {
    }
    ...
    {
        return system.isUsed() || page.isUsed();
    }
};
