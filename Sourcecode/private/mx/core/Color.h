...
class Color
{
  public:
    ...
    explicit Color(const IntType alpha, const IntType red, const IntType green, const IntType blue);
    explicit Color(const IntType red, const IntType green, const IntType blue);
