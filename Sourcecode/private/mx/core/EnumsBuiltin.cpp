...
XlinkActuate parseXlinkActuate(const std::string &value)
{
    ...
    {
        return XlinkActuate::onRequest;
    }
    else if (value == "other")
    {
        return XlinkActuate::other;
    }
    else if (value == "none")
    {
        return XlinkActuate::none;
    }
    return XlinkActuate::onLoad;
}
...
std::string toString(const XlinkActuate value)
{
    switch (value)
    {
    case XlinkActuate::onLoad:
        return "onLoad";
    case XlinkActuate::onRequest:
        return "onRequest";
    case XlinkActuate::other:
        return "other";
    case XlinkActuate::none:
        return "none";
    default:
        break;
    }
...
std::string toString(const XlinkShow value)
{
    ...
    case XlinkShow::new_:
        return "new";
    case XlinkShow::replace:
        return "replace";
    case XlinkShow::embed:
        return "embed";
    case XlinkShow::other:
        return "other";
    case XlinkShow::none:
        return "none";
    default:
...
std::string toString(const XlinkType value)
{
    switch (value)
    {
    case XlinkType::simple:
        return "simple";
    case XlinkType::extended:
        return "extended";
    case XlinkType::title:
        return "title";
    case XlinkType::resource:
        return "resource";
    case XlinkType::locator:
        return "locator";
    case XlinkType::arc:
        return "arc";
    default:
