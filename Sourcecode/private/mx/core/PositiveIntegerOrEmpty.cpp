...
{
  public:
    explicit impl() : myPositiveInteger(1), myIsEmpty(true)
    {
    }

    explicit impl(const PositiveInteger &value) : myPositiveInteger(value), myIsEmpty(false)
    {
    }

    explicit impl(const std::string &value) : myPositiveInteger(1), myIsEmpty(false)
    {
        parse(value);
    }
...
PositiveIntegerOrEmpty::PositiveIntegerOrEmpty() : myImpl(new impl())
{
}

PositiveIntegerOrEmpty::PositiveIntegerOrEmpty(const PositiveInteger &value) : myImpl(new impl(value))
{
}

PositiveIntegerOrEmpty::PositiveIntegerOrEmpty(const std::string &value) : myImpl(new impl(value))
{
}
...
PositiveIntegerOrEmpty::PositiveIntegerOrEmpty(PositiveIntegerOrEmpty &&other) : myImpl(std::move(other.myImpl))
{
}
