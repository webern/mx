...
inline DistancePtr makeDistance()
{
    return std::make_shared<Distance>();
}

inline DistancePtr makeDistance(const TenthsValue &value)
{
    return std::make_shared<Distance>(value);
}

inline DistancePtr makeDistance(TenthsValue &&value)
{
    return std::make_shared<Distance>(std::move(value));
}
