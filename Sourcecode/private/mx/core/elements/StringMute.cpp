...
namespace core
{
StringMute::StringMute() : ElementInterface(), myAttributes(std::make_shared<StringMuteAttributes>())
{
}
...
bool StringMute::hasContents() const
{
    return false;
}
...
std::ostream &StringMute::streamName(std::ostream &os) const
{
    os << "string-mute";
    return os;
}
...
bool StringMute::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
