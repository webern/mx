...
inline RightsPtr makeRights()
{
    return std::make_shared<Rights>();
}

inline RightsPtr makeRights(const XsString &value)
{
    return std::make_shared<Rights>(value);
}

inline RightsPtr makeRights(XsString &&value)
{
    return std::make_shared<Rights>(std::move(value));
}
