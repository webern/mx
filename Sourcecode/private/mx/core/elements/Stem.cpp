...
namespace core
{
Stem::Stem() : myValue(StemValue::none), myAttributes(std::make_shared<StemAttributes>())
{
}

Stem::Stem(const StemValue &value) : myValue(value), myAttributes(std::make_shared<StemAttributes>())
{
}
...
bool Stem::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    bool isSuccess = true;
