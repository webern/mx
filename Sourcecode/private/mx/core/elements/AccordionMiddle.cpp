...
namespace core
{
AccordionMiddle::AccordionMiddle() : myValue()
{
}

AccordionMiddle::AccordionMiddle(const AccordionMiddleValue &value) : myValue(value)
{
}
...
bool AccordionMiddle::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    MX_UNUSED(message);
    MX_UNUSED(xelement);
