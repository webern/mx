...
namespace core
{
GroupAbbreviationDisplayAttributes::GroupAbbreviationDisplayAttributes() : printObject(YesNo::no), hasPrintObject(false)
{
}
...
bool GroupAbbreviationDisplayAttributes::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
