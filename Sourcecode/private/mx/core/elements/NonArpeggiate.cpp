...
namespace core
{
NonArpeggiate::NonArpeggiate() : ElementInterface(), myAttributes(std::make_shared<NonArpeggiateAttributes>())
{
}
...
bool NonArpeggiate::hasContents() const
{
    return false;
}
...
std::ostream &NonArpeggiate::streamName(std::ostream &os) const
{
    os << "non-arpeggiate";
    return os;
}
...
bool NonArpeggiate::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
