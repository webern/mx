...
RightDivider::RightDivider()
    : ElementInterface(), myAttributes(std::make_shared<EmptyPrintObjectStyleAlignAttributes>())
{
}
...
bool RightDivider::hasContents() const
{
    return false;
}
...
std::ostream &RightDivider::streamName(std::ostream &os) const
{
    os << "right-divider";
    return os;
}
...
bool RightDivider::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
