...
namespace core
{
MidiUnpitched::MidiUnpitched() : myValue()
{
}

MidiUnpitched::MidiUnpitched(const Midi128 &value) : myValue(value)
{
}
...
bool MidiUnpitched::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    MX_UNUSED(message);
    MX_UNUSED(xelement);
