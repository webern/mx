...
namespace core
{
Supports::Supports() : ElementInterface(), myAttributes(std::make_shared<SupportsAttributes>())
{
}
...
bool Supports::hasContents() const
{
    return false;
}
...
std::ostream &Supports::streamName(std::ostream &os) const
{
    os << "supports";
    return os;
}
