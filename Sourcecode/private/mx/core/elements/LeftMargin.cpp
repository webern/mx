...
namespace core
{
LeftMargin::LeftMargin() : myValue()
{
}

LeftMargin::LeftMargin(const TenthsValue &value) : myValue(value)
{
}
...
bool LeftMargin::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    MX_UNUSED(message);
    MX_UNUSED(xelement);
