...
ScoreHeaderGroup::ScoreHeaderGroup()
    : myWork(makeWork()), myHasWork(false), myMovementNumber(makeMovementNumber()), myHasMovementNumber(false),
      myMovementTitle(makeMovementTitle()), myHasMovementTitle(false), myIdentification(makeIdentification()),
      myHasIdentification(false), myDefaults(makeDefaults()), myHasDefaults(false), myCreditSet(),
