...
inline SuffixPtr makeSuffix()
{
    return std::make_shared<Suffix>();
}

inline SuffixPtr makeSuffix(const XsString &value)
{
    return std::make_shared<Suffix>(value);
}

inline SuffixPtr makeSuffix(XsString &&value)
{
    return std::make_shared<Suffix>(std::move(value));
}
