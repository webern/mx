...
namespace core
{
CreditImage::CreditImage() : ElementInterface(), myAttributes(std::make_shared<CreditImageAttributes>())
{
}
...
bool CreditImage::hasContents() const
{
    return false;
}
...
std::ostream &CreditImage::streamName(std::ostream &os) const
{
    os << "credit-image";
    return os;
}
...
bool CreditImage::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
