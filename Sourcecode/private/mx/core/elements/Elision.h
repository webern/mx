...
inline ElisionPtr makeElision()
{
    return std::make_shared<Elision>();
}

inline ElisionPtr makeElision(const XsString &value)
{
    return std::make_shared<Elision>(value);
}

inline ElisionPtr makeElision(XsString &&value)
{
    return std::make_shared<Elision>(std::move(value));
}
