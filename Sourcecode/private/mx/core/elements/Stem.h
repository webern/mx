...
inline StemPtr makeStem()
{
    return std::make_shared<Stem>();
}

inline StemPtr makeStem(const StemValue &value)
{
    return std::make_shared<Stem>(value);
}

inline StemPtr makeStem(StemValue &&value)
{
    return std::make_shared<Stem>(std::move(value));
}
