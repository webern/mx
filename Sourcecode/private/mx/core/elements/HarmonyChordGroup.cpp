...
HarmonyChordGroup::HarmonyChordGroup()
    : myChoice(Choice::root), myRoot(makeRoot()), myFunction(makeFunction()), myKind(makeKind()),
      myInversion(makeInversion()), myHasInversion(false), myBass(makeBass()), myHasBass(false), myDegreeSet()
{
}
