...
namespace core
{
TrillMark::TrillMark() : ElementInterface(), myAttributes(std::make_shared<EmptyTrillSoundAttributes>())
{
}
...
bool TrillMark::hasContents() const
{
    return false;
}
...
std::ostream &TrillMark::streamName(std::ostream &os) const
{
    os << "trill-mark";
    return os;
}
...
bool TrillMark::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
