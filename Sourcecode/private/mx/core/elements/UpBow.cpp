...
namespace core
{
UpBow::UpBow() : ElementInterface(), myAttributes(std::make_shared<EmptyPlacementAttributes>())
{
}
...
std::ostream &UpBow::streamName(std::ostream &os) const
{
    os << "up-bow";
    return os;
}
...
bool UpBow::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
