...
namespace core
{
MidiBank::MidiBank() : myValue()
{
}

MidiBank::MidiBank(const Midi16384 &value) : myValue(value)
{
}
...
bool MidiBank::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    MX_UNUSED(message);
    MX_UNUSED(xelement);
