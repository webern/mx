...
namespace core
{
HoleShape::HoleShape() : myValue()
{
}

HoleShape::HoleShape(const XsString &value) : myValue(value)
{
}
...
bool HoleShape::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    MX_UNUSED(message);
    MX_UNUSED(xelement);
