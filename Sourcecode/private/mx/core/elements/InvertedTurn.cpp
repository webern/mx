...
namespace core
{
InvertedTurn::InvertedTurn() : ElementInterface(), myAttributes(std::make_shared<InvertedTurnAttributes>())
{
}
...
bool InvertedTurn::hasContents() const
{
    return false;
}
...
std::ostream &InvertedTurn::streamName(std::ostream &os) const
{
    os << "inverted-turn";
    return os;
}
