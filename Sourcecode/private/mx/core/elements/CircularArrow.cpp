...
namespace core
{
CircularArrow::CircularArrow() : myValue(CircularArrowEnum::clockwise)
{
}

CircularArrow::CircularArrow(const CircularArrowEnum &value) : myValue(value)
{
}
...
bool CircularArrow::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    MX_UNUSED(message);
