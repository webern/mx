...
inline GroupBarlinePtr makeGroupBarline()
{
    return std::make_shared<GroupBarline>();
}

inline GroupBarlinePtr makeGroupBarline(const GroupBarlineValue &value)
{
    return std::make_shared<GroupBarline>(value);
}

inline GroupBarlinePtr makeGroupBarline(GroupBarlineValue &&value)
{
    return std::make_shared<GroupBarline>(std::move(value));
}
