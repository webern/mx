...
namespace core
{
PartList::PartList() : myPartGroupSet(), myScorePart(makeScorePart()), myPartGroupOrScorePartSet()
{
}
...
bool PartList::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    bool isSuccess = true;
