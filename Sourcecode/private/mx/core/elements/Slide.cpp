...
namespace core
{
Slide::Slide() : myValue(), myAttributes(std::make_shared<SlideAttributes>())
{
}

Slide::Slide(const XsString &value) : myValue(value), myAttributes(std::make_shared<SlideAttributes>())
{
}
...
bool Slide::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    bool isSuccess = true;
