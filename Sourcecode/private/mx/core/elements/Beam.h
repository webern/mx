...
inline BeamPtr makeBeam()
{
    return std::make_shared<Beam>();
}

inline BeamPtr makeBeam(const BeamValue &value)
{
    return std::make_shared<Beam>(value);
}

inline BeamPtr makeBeam(BeamValue &&value)
{
    return std::make_shared<Beam>(std::move(value));
}
