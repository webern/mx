...
namespace core
{
Falloff::Falloff() : ElementInterface(), myAttributes(std::make_shared<EmptyLineAttributes>())
{
}
...
bool Falloff::hasContents() const
{
    return false;
}
...
std::ostream &Falloff::streamName(std::ostream &os) const
{
    os << "falloff";
    return os;
}
