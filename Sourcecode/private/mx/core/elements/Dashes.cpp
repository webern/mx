...
namespace core
{
Dashes::Dashes() : ElementInterface(), myAttributes(std::make_shared<DashesAttributes>())
{
}
...
std::ostream &Dashes::streamName(std::ostream &os) const
{
    os << "dashes";
    return os;
}
