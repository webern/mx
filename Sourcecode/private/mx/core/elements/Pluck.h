...
inline PluckPtr makePluck()
{
    return std::make_shared<Pluck>();
}

inline PluckPtr makePluck(const XsString &value)
{
    return std::make_shared<Pluck>(value);
}

inline PluckPtr makePluck(XsString &&value)
{
    return std::make_shared<Pluck>(std::move(value));
}
