...
inline FingeringPtr makeFingering()
{
    return std::make_shared<Fingering>();
}

inline FingeringPtr makeFingering(const XsString &value)
{
    return std::make_shared<Fingering>(value);
}

inline FingeringPtr makeFingering(XsString &&value)
{
    return std::make_shared<Fingering>(std::move(value));
}
