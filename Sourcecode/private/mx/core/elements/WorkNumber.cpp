...
namespace core
{
WorkNumber::WorkNumber() : myValue()
{
}

WorkNumber::WorkNumber(const XsString &value) : myValue(value)
{
}
...
bool WorkNumber::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    MX_UNUSED(message);
    MX_UNUSED(xelement);
