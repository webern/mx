...
namespace core
{
NormalType::NormalType() : myValue(NoteTypeValue::eighth)
{
}

NormalType::NormalType(const NoteTypeValue &value) : myValue(value)
{
}
...
bool NormalType::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    MX_UNUSED(message);
