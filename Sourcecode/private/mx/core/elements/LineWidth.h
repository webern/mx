...
inline LineWidthPtr makeLineWidth()
{
    return std::make_shared<LineWidth>();
}

inline LineWidthPtr makeLineWidth(const TenthsValue &value)
{
    return std::make_shared<LineWidth>(value);
}

inline LineWidthPtr makeLineWidth(TenthsValue &&value)
{
    return std::make_shared<LineWidth>(std::move(value));
}
