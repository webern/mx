...
namespace core
{
PedalStep::PedalStep() : myValue(StepEnum::a)
{
}

PedalStep::PedalStep(const StepEnum &value) : myValue(value)
{
}
...
bool PedalStep::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    MX_UNUSED(message);
