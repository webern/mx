...
namespace core
{
Stress::Stress() : ElementInterface(), myAttributes(std::make_shared<EmptyPlacementAttributes>())
{
}
...
std::ostream &Stress::streamName(std::ostream &os) const
{
    os << "stress";
    return os;
}
