...
namespace core
{
FrameFrets::FrameFrets() : myValue()
{
}

FrameFrets::FrameFrets(const PositiveInteger &value) : myValue(value)
{
}
...
bool FrameFrets::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    MX_UNUSED(message);
    MX_UNUSED(xelement);
