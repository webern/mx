...
namespace core
{
Spiccato::Spiccato() : ElementInterface(), myAttributes(std::make_shared<EmptyPlacementAttributes>())
{
}
...
bool Spiccato::hasContents() const
{
    return false;
}
...
std::ostream &Spiccato::streamName(std::ostream &os) const
{
    os << "spiccato";
    return os;
}
...
bool Spiccato::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
