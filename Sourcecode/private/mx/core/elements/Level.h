...
inline LevelPtr makeLevel()
{
    return std::make_shared<Level>();
}

inline LevelPtr makeLevel(const XsString &value)
{
    return std::make_shared<Level>(value);
}

inline LevelPtr makeLevel(XsString &&value)
{
    return std::make_shared<Level>(std::move(value));
}
