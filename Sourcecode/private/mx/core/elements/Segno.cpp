...
namespace core
{
Segno::Segno() : ElementInterface(), myAttributes(std::make_shared<EmptyPrintObjectStyleAlignAttributes>())
{
}
...
std::ostream &Segno::streamName(std::ostream &os) const
{
    os << "segno";
    return os;
}
