...
namespace core
{
TopSystemDistance::TopSystemDistance() : myValue()
{
}

TopSystemDistance::TopSystemDistance(const TenthsValue &value) : myValue(value)
{
}
...
bool TopSystemDistance::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    MX_UNUSED(message);
    MX_UNUSED(xelement);
