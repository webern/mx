...
namespace core
{
Repeat::Repeat() : ElementInterface(), myAttributes(std::make_shared<RepeatAttributes>())
{
}
...
std::ostream &Repeat::streamName(std::ostream &os) const
{
    os << "repeat";
    return os;
}
...
bool Repeat::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
