...
namespace core
{
Appearance::Appearance() : myLineWidthSet(), myNoteSizeSet(), myDistanceSet(), myOtherAppearanceSet()
{
}
...
{
    return myLineWidthSet.size() > 0 || myNoteSizeSet.size() > 0 || myDistanceSet.size() > 0 ||
