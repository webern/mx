...
namespace core
{
NormalNotes::NormalNotes() : myValue()
{
}

NormalNotes::NormalNotes(const NonNegativeInteger &value) : myValue(value)
{
}
...
bool NormalNotes::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    MX_UNUSED(message);
    MX_UNUSED(xelement);
