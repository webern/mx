...
inline WithBarPtr makeWithBar()
{
    return std::make_shared<WithBar>();
}

inline WithBarPtr makeWithBar(const XsString &value)
{
    return std::make_shared<WithBar>(value);
}

inline WithBarPtr makeWithBar(XsString &&value)
{
    return std::make_shared<WithBar>(std::move(value));
}
