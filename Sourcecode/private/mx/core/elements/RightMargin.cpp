...
namespace core
{
RightMargin::RightMargin() : myValue()
{
}

RightMargin::RightMargin(const TenthsValue &value) : myValue(value)
{
}
...
bool RightMargin::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    MX_UNUSED(message);
    MX_UNUSED(xelement);
