...
namespace core
{
MovementTitle::MovementTitle() : myValue()
{
}

MovementTitle::MovementTitle(const XsString &value) : myValue(value)
{
}
...
bool MovementTitle::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    MX_UNUSED(message);
    MX_UNUSED(xelement);
