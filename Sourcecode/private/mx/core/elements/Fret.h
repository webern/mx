...
inline FretPtr makeFret()
{
    return std::make_shared<Fret>();
}

inline FretPtr makeFret(const NonNegativeInteger &value)
{
    return std::make_shared<Fret>(value);
}

inline FretPtr makeFret(NonNegativeInteger &&value)
{
    return std::make_shared<Fret>(std::move(value));
}
