...
inline BarStylePtr makeBarStyle()
{
    return std::make_shared<BarStyle>();
}

inline BarStylePtr makeBarStyle(const BarStyleEnum &value)
{
    return std::make_shared<BarStyle>(value);
}

inline BarStylePtr makeBarStyle(BarStyleEnum &&value)
{
    return std::make_shared<BarStyle>(std::move(value));
}
