...
inline FunctionPtr makeFunction()
{
    return std::make_shared<Function>();
}

inline FunctionPtr makeFunction(const XsString &value)
{
    return std::make_shared<Function>(value);
}

inline FunctionPtr makeFunction(XsString &&value)
{
    return std::make_shared<Function>(std::move(value));
}
