...
namespace core
{
MidiName::MidiName() : myValue()
{
}

MidiName::MidiName(const XsString &value) : myValue(value)
{
}
...
bool MidiName::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    MX_UNUSED(message);
    MX_UNUSED(xelement);
