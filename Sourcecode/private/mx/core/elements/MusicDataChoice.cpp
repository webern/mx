...
MusicDataChoice::MusicDataChoice()
    : myChoice(Choice::note), myNote(nullptr), myBackup(nullptr), myForward(nullptr), myDirection(nullptr),
      myProperties(nullptr), myHarmony(nullptr), myFiguredBass(nullptr), myPrint(nullptr), mySound(nullptr),
      myBarline(nullptr), myGrouping(nullptr), myLink(nullptr), myBookmark(nullptr)
{
}
