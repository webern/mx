...
namespace core
{
Wedge::Wedge() : ElementInterface(), myAttributes(std::make_shared<WedgeAttributes>())
{
}
...
std::ostream &Wedge::streamName(std::ostream &os) const
{
    os << "wedge";
    return os;
}
