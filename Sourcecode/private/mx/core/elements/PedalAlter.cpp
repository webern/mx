...
namespace core
{
PedalAlter::PedalAlter() : myValue()
{
}

PedalAlter::PedalAlter(const Semitones &value) : myValue(value)
{
}
...
bool PedalAlter::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    MX_UNUSED(message);
    MX_UNUSED(xelement);
