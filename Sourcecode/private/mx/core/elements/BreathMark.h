...
inline BreathMarkPtr makeBreathMark()
{
    return std::make_shared<BreathMark>();
}

inline BreathMarkPtr makeBreathMark(const BreathMarkValue &value)
{
    return std::make_shared<BreathMark>(value);
}

inline BreathMarkPtr makeBreathMark(BreathMarkValue &&value)
{
    return std::make_shared<BreathMark>(std::move(value));
}
