...
namespace core
{
Diatonic::Diatonic() : myValue()
{
}

Diatonic::Diatonic(const Integer &value) : myValue(value)
{
}
...
bool Diatonic::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    MX_UNUSED(message);
    MX_UNUSED(xelement);
