...
namespace core
{
Chromatic::Chromatic() : myValue()
{
}

Chromatic::Chromatic(const Semitones &value) : myValue(value)
{
}
...
bool Chromatic::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    MX_UNUSED(message);
    MX_UNUSED(xelement);
