...
inline PrefixPtr makePrefix()
{
    return std::make_shared<Prefix>();
}

inline PrefixPtr makePrefix(const XsString &value)
{
    return std::make_shared<Prefix>(value);
}

inline PrefixPtr makePrefix(XsString &&value)
{
    return std::make_shared<Prefix>(std::move(value));
}
