...
namespace core
{
Ensemble::Ensemble() : myValue()
{
}

Ensemble::Ensemble(const PositiveIntegerOrEmpty &value) : myValue(value)
{
}
...
bool Ensemble::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    MX_UNUSED(message);
    MX_UNUSED(xelement);
