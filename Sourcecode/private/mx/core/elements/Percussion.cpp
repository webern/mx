...
namespace core
{
Percussion::Percussion() : myAttributes(std::make_shared<PercussionAttributes>()), myChoice(makePercussionChoice())
{
}
...
bool Percussion::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    bool isSuccess = true;
