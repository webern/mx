...
namespace core
{
StaffLines::StaffLines() : myValue()
{
}

StaffLines::StaffLines(const NonNegativeInteger &value) : myValue(value)
{
}
...
bool StaffLines::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    MX_UNUSED(message);
    MX_UNUSED(xelement);
