...
namespace core
{
OtherAppearanceAttributes::OtherAppearanceAttributes() : type("undefined"), hasType(true)
{
}
...
bool OtherAppearanceAttributes::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
