...
namespace core
{
StaffDistance::StaffDistance() : myValue()
{
}

StaffDistance::StaffDistance(const TenthsValue &value) : myValue(value)
{
}
...
bool StaffDistance::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    MX_UNUSED(message);
    MX_UNUSED(xelement);
