...
inline PartNamePtr makePartName()
{
    return std::make_shared<PartName>();
}

inline PartNamePtr makePartName(const XsString &value)
{
    return std::make_shared<PartName>(value);
}

inline PartNamePtr makePartName(XsString &&value)
{
    return std::make_shared<PartName>(std::move(value));
}
