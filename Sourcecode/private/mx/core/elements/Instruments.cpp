...
namespace core
{
Instruments::Instruments() : myValue()
{
}

Instruments::Instruments(const NonNegativeInteger &value) : myValue(value)
{
}
...
bool Instruments::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    MX_UNUSED(message);
    MX_UNUSED(xelement);
