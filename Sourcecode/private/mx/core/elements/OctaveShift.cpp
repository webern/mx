...
namespace core
{
OctaveShift::OctaveShift() : ElementInterface(), myAttributes(std::make_shared<OctaveShiftAttributes>())
{
}
...
bool OctaveShift::hasContents() const
{
    return false;
}
...
std::ostream &OctaveShift::streamName(std::ostream &os) const
{
    os << "octave-shift";
    return os;
}
...
bool OctaveShift::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
