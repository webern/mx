...
inline HoleClosedPtr makeHoleClosed()
{
    return std::make_shared<HoleClosed>();
}

inline HoleClosedPtr makeHoleClosed(const HoleClosedValue &value)
{
    return std::make_shared<HoleClosed>(value);
}

inline HoleClosedPtr makeHoleClosed(HoleClosedValue &&value)
{
    return std::make_shared<HoleClosed>(std::move(value));
}
