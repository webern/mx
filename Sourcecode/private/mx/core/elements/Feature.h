...
inline FeaturePtr makeFeature()
{
    return std::make_shared<Feature>();
}

inline FeaturePtr makeFeature(const XsString &value)
{
    return std::make_shared<Feature>(value);
}

inline FeaturePtr makeFeature(XsString &&value)
{
    return std::make_shared<Feature>(std::move(value));
}
