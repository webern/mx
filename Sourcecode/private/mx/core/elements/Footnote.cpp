...
namespace core
{
Footnote::Footnote() : myValue(), myAttributes(std::make_shared<FootnoteAttributes>())
{
}

Footnote::Footnote(const XsString &value) : myValue(value), myAttributes(std::make_shared<FootnoteAttributes>())
{
}
