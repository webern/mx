...
namespace core
{
Tied::Tied() : ElementInterface(), myAttributes(std::make_shared<TiedAttributes>())
{
}
...
std::ostream &Tied::streamName(std::ostream &os) const
{
    os << "tied";
    return os;
}
...
bool Tied::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
