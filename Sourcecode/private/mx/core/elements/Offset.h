...
inline OffsetPtr makeOffset()
{
    return std::make_shared<Offset>();
}

inline OffsetPtr makeOffset(const DivisionsValue &value)
{
    return std::make_shared<Offset>(value);
}

inline OffsetPtr makeOffset(DivisionsValue &&value)
{
    return std::make_shared<Offset>(std::move(value));
}
