...
namespace core
{
Stopped::Stopped() : ElementInterface(), myAttributes(std::make_shared<EmptyPlacementAttributes>())
{
}
...
bool Stopped::hasContents() const
{
    return false;
}
...
std::ostream &Stopped::streamName(std::ostream &os) const
{
    os << "stopped";
    return os;
}
