...
namespace core
{
Grace::Grace() : ElementInterface(), myAttributes(std::make_shared<GraceAttributes>())
{
}
...
std::ostream &Grace::streamName(std::ostream &os) const
{
    os << "grace";
    return os;
}
...
bool Grace::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
