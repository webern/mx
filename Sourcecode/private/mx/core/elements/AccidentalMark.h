...
inline AccidentalMarkPtr makeAccidentalMark()
{
    return std::make_shared<AccidentalMark>();
}

inline AccidentalMarkPtr makeAccidentalMark(const AccidentalValue &value)
{
    return std::make_shared<AccidentalMark>(value);
}

inline AccidentalMarkPtr makeAccidentalMark(AccidentalValue &&value)
{
    return std::make_shared<AccidentalMark>(std::move(value));
}
