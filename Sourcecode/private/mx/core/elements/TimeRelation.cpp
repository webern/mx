...
namespace core
{
TimeRelation::TimeRelation() : myValue(TimeRelationEnum::equals)
{
}

TimeRelation::TimeRelation(const TimeRelationEnum &value) : myValue(value)
{
}
...
bool TimeRelation::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    MX_UNUSED(message);
