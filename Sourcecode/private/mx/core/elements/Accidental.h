...
inline AccidentalPtr makeAccidental()
{
    return std::make_shared<Accidental>();
}

inline AccidentalPtr makeAccidental(const AccidentalValue &value)
{
    return std::make_shared<Accidental>(value);
}

inline AccidentalPtr makeAccidental(AccidentalValue &&value)
{
    return std::make_shared<Accidental>(std::move(value));
}
