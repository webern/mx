...
namespace core
{
SemiPitched::SemiPitched() : myValue(SemiPitchedEnum::medium)
{
}

SemiPitched::SemiPitched(const SemiPitchedEnum &value) : myValue(value)
{
}
...
bool SemiPitched::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    MX_UNUSED(message);
