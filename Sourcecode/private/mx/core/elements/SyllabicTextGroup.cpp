...
SyllabicTextGroup::SyllabicTextGroup()
    : mySyllabic(makeSyllabic()), myHasSyllabic(false), myText(makeText()), myElisionSyllabicTextGroupSet(),
      myExtend(makeExtend()), myHasExtend(false)
{
}
...
ElisionSyllabicTextGroupPtr SyllabicTextGroup::getElisionSyllabicTextGroup(
    const ElisionSyllabicTextGroupSetIterConst &setIterator) const
{
