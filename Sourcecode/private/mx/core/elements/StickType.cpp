...
namespace core
{
StickType::StickType() : myValue(StickTypeEnum::yarn)
{
}

StickType::StickType(const StickTypeEnum &value) : myValue(value)
{
}
...
bool StickType::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    MX_UNUSED(message);
