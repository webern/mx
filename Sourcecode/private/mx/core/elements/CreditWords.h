...
inline CreditWordsPtr makeCreditWords()
{
    return std::make_shared<CreditWords>();
}

inline CreditWordsPtr makeCreditWords(const XsString &value)
{
    return std::make_shared<CreditWords>(value);
}

inline CreditWordsPtr makeCreditWords(XsString &&value)
{
    return std::make_shared<CreditWords>(std::move(value));
}
