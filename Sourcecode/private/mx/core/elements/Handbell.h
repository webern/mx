...
inline HandbellPtr makeHandbell()
{
    return std::make_shared<Handbell>();
}

inline HandbellPtr makeHandbell(const HandbellValue &value)
{
    return std::make_shared<Handbell>(value);
}

inline HandbellPtr makeHandbell(HandbellValue &&value)
{
    return std::make_shared<Handbell>(std::move(value));
}
