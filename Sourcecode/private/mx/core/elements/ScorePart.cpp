...
{
ScorePart::ScorePart()
    : myAttributes(std::make_shared<ScorePartAttributes>()), myIdentification(makeIdentification()),
      myHasIdentification(false), myPartName(makePartName()), myPartNameDisplay(makePartNameDisplay()),
      myHasPartNameDisplay(false), myPartAbbreviation(makePartAbbreviation()), myHasPartAbbreviation(false),
      myPartAbbreviationDisplay(makePartAbbreviationDisplay()), myHasPartAbbreviationDisplay(false), myGroupSet(),
      myScoreInstrumentSet(), myMidiDeviceInstrumentGroupSet()
{
}
...
MidiDeviceInstrumentGroupPtr ScorePart::getMidiDeviceInstrumentGroup(
    const MidiDeviceInstrumentGroupSetIterConst &setIterator) const
{
...
void ScorePart::importMidiDeviceInstrumentGroupSet(std::ostream &message, ::ezxml::XElementIterator &iter,
