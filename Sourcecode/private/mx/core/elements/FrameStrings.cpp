...
namespace core
{
FrameStrings::FrameStrings() : myValue()
{
}

FrameStrings::FrameStrings(const PositiveInteger &value) : myValue(value)
{
}
...
bool FrameStrings::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    MX_UNUSED(message);
    MX_UNUSED(xelement);
