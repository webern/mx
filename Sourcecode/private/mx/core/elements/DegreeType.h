...
inline DegreeTypePtr makeDegreeType()
{
    return std::make_shared<DegreeType>();
}

inline DegreeTypePtr makeDegreeType(const DegreeTypeValue &value)
{
    return std::make_shared<DegreeType>(value);
}

inline DegreeTypePtr makeDegreeType(DegreeTypeValue &&value)
{
    return std::make_shared<DegreeType>(std::move(value));
}
