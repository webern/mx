...
namespace core
{
DetachedLegato::DetachedLegato() : ElementInterface(), myAttributes(std::make_shared<EmptyPlacementAttributes>())
{
}
...
bool DetachedLegato::hasContents() const
{
    return false;
}
...
std::ostream &DetachedLegato::streamName(std::ostream &os) const
{
    os << "detached-legato";
    return os;
}
...
bool DetachedLegato::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
