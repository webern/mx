...
PercussionChoice::PercussionChoice()
    ...
    : myChoice(PercussionChoice::Choice::glass), myGlass(makeGlass()), myMetal(makeMetal()), myWood(makeWood()),
      ...
      myStickLocation(makeStickLocation()), myOtherPercussion(makeOtherPercussion())
{
}
...
bool PercussionChoice::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
