...
namespace core
{
MetronomeType::MetronomeType() : myValue(NoteTypeValue::eighth)
{
}

MetronomeType::MetronomeType(const NoteTypeValue &value) : myValue(value)
{
}
...
bool MetronomeType::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    MX_UNUSED(message);
