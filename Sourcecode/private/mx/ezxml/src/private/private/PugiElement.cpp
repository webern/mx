...
#define EZXML_CHECK_NULL_NODE                                                                                          \
    if (getIsNull())                                                                                                   \
    {                                                                                                                  \
        EZXML_THROW_XNULL;                                                                                             \
    }
#define EZXML_CHECK_NODE_ELEMENT                                                                                       \
    if (myNodeType != pugi::node_element && myNodeType != pugi::node_pi)                                               \
    {                                                                                                                  \
...
PugiElement::PugiElement(const pugi::xml_node &node, const XDocCPtr &xdoc)
...
XElementIterator PugiElement::begin() const
{
    ...
    if (iter.getSkipProcessingInstructions() && iter != end() && iter->getIsProcessingInstruction())
    {
        ++iter;
    }
...
XElementIterator PugiElement::beginWithProcessingInstructions() const
{
    ...
    if (type == pugi::node_element || type == pugi::node_pi)
    {
