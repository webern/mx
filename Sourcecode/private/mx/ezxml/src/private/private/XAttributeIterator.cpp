...
namespace ezxml
{
XAttributeIterator::XAttributeIterator() : myImpl(nullptr)
{
}

XAttributeIterator::XAttributeIterator(const XAttributeIterImpl &impl) : myImpl(impl.clone())
{
}

XAttributeIterator::XAttributeIterator(const XAttributeIterator &other) : myImpl(nullptr)
{
    if (other.myImpl)
    {
