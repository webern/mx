...
void setPartwiseMeasureProperties(mx::core::PartwiseMeasurePtr &measure, int measureNumber, int divisions, int beats,
                                  int beatType);

mx::core::MusicDataChoicePtr makeNote(mx::core::StepEnum step, int octave, mx::core::NoteTypeValue duration,
                                      int divisions);
