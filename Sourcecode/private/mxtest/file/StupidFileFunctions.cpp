...
std::string concatFileNameParts(const std::string &fileNamePart, const std::string &fileExtensionPart)
{
    std::stringstream ss;
...
std::string filePath(const std::string &subdirectory, const std::string &fileName)
{
    std::stringstream ss;
...
void openInputFile(std::ifstream &outFileRef, const std::string &inFullpath)
{
...
void openOutputFile(std::ofstream &outFileRef, const std::string &inFullpath)
{
...
void openAppendFile(std::ofstream &outFileRef, const std::string &inFullpath)
{
