...
namespace mxtest
{
    ...
    inline ScoreData expectedScoreData()
    {
        ScoreData scoreData;
        scoreData.musicXmlType = "partwise";
...
TEST( abc, xyz )
{
    auto scoreData = mxtest::expectedScoreData();
    auto scoreData2 = scoreData;
//    scoreData2.workTitle = ".";
    scoreData2.parts.emplace_back( PartData{} );
    std::cout << (scoreData==scoreData2) << std::endl;
    CHECK_EQUAL( scoreData.parts.size(), 1 );
}
