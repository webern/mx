...
void setPartwiseMeasureProperties(PartwiseMeasurePtr &measure, int measureNumber, int divisions, int beats,
                                  int beatType)
{
...
MusicDataChoicePtr makeNote(StepEnum step, int octave, NoteTypeValue duration, int divisions)
{
    ...
    p1m1_noteData->getNote()
        ->getNoteChoice()
        ->getNormalNoteGroup()
        ->getFullNoteGroup()
        ->getFullNoteTypeChoice()
        ->setChoice(FullNoteTypeChoice::Choice::pitch);
    p1m1_noteData->getNote()
        ->getNoteChoice()
        ->getNormalNoteGroup()
        ->getFullNoteGroup()
    ...
    p1m1_noteData->getNote()
        ...
        ->getPitch()
        ->getOctave()
        ->setValue(OctaveValue(octave));
    p1m1_noteData->getNote()->getNoteChoice()->getNormalNoteGroup()->getDuration()->setValue(
        PositiveDivisionsValue(divisions));
