...
MxFileRepository::MxFileRepository()
    : myPath{mxtest::getResourcesDirectoryPath()}, mySeparator{FILE_PATH_SEPARATOR}, myExpectedLoadFailures{},
      myNameSubdirectoryMap{}, myTestFiles{}
{
...
const MxFile &MxFileRepository::getTestFile(const std::string &fileName)
{
    ...
    auto lambda = [&](const MxFile &inMxFile) { return fileName == inMxFile.fileName; };
