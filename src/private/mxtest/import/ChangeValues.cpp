...
namespace mxtest
{
void convertValues(::ezxml::XDoc &xdoc, const std::string &elementName, const std::string &existingValue,
                   const std::string desiredValue)
{
    convertValues(*xdoc.getRoot(), elementName, existingValue, desiredValue);
}

void convertValues(::ezxml::XElement &xelement, const std::string &elementName, const std::string &existingValue,
                   const std::string desiredValue)
{
...
void addChildIfNone(::ezxml::XDoc &xdoc, const std::string &elementName, const std::string &childNameToAdd,
                    const std::string childValueToAdd)
{
    addChildIfNone(*xdoc.getRoot(), elementName, childNameToAdd, childValueToAdd);
}

void addChildIfNone(::ezxml::XElement &xelement, const std::string &elementName, const std::string &childNameToAdd,
                    const std::string childValueToAdd)
{
...
void addAttributeIfNone(::ezxml::XDoc &xdoc, const std::string &elementName, const std::string &attributeNameToAdd,
                        const std::string attributeValueToAdd)
{
    addAttributeIfNone(*xdoc.getRoot(), elementName, attributeNameToAdd, attributeValueToAdd);
}

void addAttributeIfNone(::ezxml::XElement &xelement, const std::string &elementName,
                        const std::string &attributeNameToAdd, const std::string attributeValueToAdd)
{
...
void removeAttribute(::ezxml::XElement &xelement, const std::string &elementName,
                     const std::string &attributeNameToRemove)
{
    if (xelement.getName() == elementName)
    {
        for (auto it = xelement.attributesBegin(); it != xelement.attributesEnd(); ++it)
...
void changeAttributeValue(::ezxml::XDoc &xdoc, const std::string &elementName, const std::string &attributeName,
                          const std::string &undesiredValueToReplace, const std::string &replacementValue)
{
    changeAttributeValue(*xdoc.getRoot(), elementName, attributeName, undesiredValueToReplace, replacementValue);
}

void changeAttributeValue(::ezxml::XElement &xelement, const std::string &elementName, const std::string &attributeName,
                          const std::string &undesiredValueToReplace, const std::string &replacementValue)
{
    if (xelement.getName() == elementName)
    {
