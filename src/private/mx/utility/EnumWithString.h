...
#define MX_ENUM_VALUE(value, string)                                                                                   \
    static constexpr const char *const MX_STRING_CONSTANT_NAME(RETURN_MX_ENUM_CLASS_NAME(MX_ENUM_CLASS_NAME), value) = \
        string;
...
#define MX_ENUM_VALUE(value, string)                                                                                   \
    case MX_ENUM_CLASS_NAME::value:                                                                                    \
        return MX_STRING_CONSTANT_NAME(RETURN_MX_ENUM_CLASS_NAME(MX_ENUM_CLASS_NAME), value);
...
#define MX_ENUM_VALUE(value, string)                                                                                   \
    if (inValue == MX_STRING_CONSTANT_NAME(RETURN_MX_ENUM_CLASS_NAME(MX_ENUM_CLASS_NAME), value))                      \
    {                                                                                                                  \
