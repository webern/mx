...
#define MX_ATTR_FUNC_OPTIONAL_WITH_GETTER(attributeFieldName, attributeFieldNameCapitalized, attributeType,            \
                                          defaultReturnValue)                                                          \
                                                                                                                       \
    template <class T>                                                                                                 \
...
#define MX_ATTR_SETFUNC_OPTIONAL_WITH_SETTER(attributeFieldName, attributeFieldNameCapitalized, attributeType,         \
                                             failureReturnValue)                                                       \
                                                                                                                       \
    template <class ATTRIBUTES_STRUCT, class VALUE_TYPE>                                                               \
    auto MXIMPLFUNC_lookForAndSet##attributeFieldNameCapitalized(                                                      \
