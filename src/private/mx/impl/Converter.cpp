...
const std::map<core::TechnicalChoice::Choice, api::MarkType> Converter::technicalMarkMap = {
    ...
    std::pair<core::TechnicalChoice::Choice, api::MarkType>{core::TechnicalChoice::Choice::string_,
                                                            api::MarkType::string_},
    // std::pair<core::TechnicalChoice::Choice, api::MarkType>{ core::TechnicalChoice::Choice::hammerOn,
    // api::MarkType::unspecified }, std::pair<core::TechnicalChoice::Choice, api::MarkType>{
    // core::TechnicalChoice::Choice::pullOff, api::MarkType::unspecified }, std::pair<core::TechnicalChoice::Choice,
    // api::MarkType>{ core::TechnicalChoice::Choice::bend, api::MarkType::unspecified },
    // std::pair<core::TechnicalChoice::Choice, api::MarkType>{ core::TechnicalChoice::Choice::tap,
    // api::MarkType::unspecified },
    ...
    std::pair<core::TechnicalChoice::Choice, api::MarkType>{core::TechnicalChoice::Choice::handbell,
                                                            api::MarkType::handbell},
