...
// Internal to the impl layer (fromScore): when a ScoreData describes
// something the new core won't represent (e.g. a
// ninth beam against the bounded addBeam), the writer refuses rather than
// silently dropping user data. Writers throw this; the api boundary catches
// it and returns the carried ApiError. Never escapes mx::api.
