...
namespace ezxml
{
PugiAttributeIterImpl::PugiAttributeIterImpl() : myIter(), myParentElement(), myXDoc(), myReturnableAttribute()
{
}

PugiAttributeIterImpl::PugiAttributeIterImpl(const pugi::xml_attribute_iterator &iter,
                                             const pugi::xml_node &iterParentElement, const XDocCPtr &parentXDoc)
