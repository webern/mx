...
{
    explicit my_equal(const std::locale &loc) : myLoc(loc)
    {
    }
...
inline bool containsCaseInsensitive(const std::string &substringToFind, const std::string &stringToFindItIn)
{
