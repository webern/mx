...
namespace ezxml
{
PugiAttribute::PugiAttribute() : myAttribute(), myParentElement(), myXDoc()
{
}

PugiAttribute::PugiAttribute(const pugi::xml_attribute &attribute, const pugi::xml_node &parentElement,
