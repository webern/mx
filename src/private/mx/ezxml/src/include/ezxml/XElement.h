...
inline std::string toString(XElementType t)
{
    switch (t)
    {
    case XElementType::null:
        return xElementNullString;
    case XElementType::empty:
        return xElementEmptyString;
    case XElementType::element:
        return xElementElementString;
    case XElementType::text:
        return xElementTextString;
    default:
        break;
    }
...
inline XElementType xElementTypeFromString(const std::string &inString)
{
