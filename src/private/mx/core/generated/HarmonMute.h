...
class HarmonMute final
{
  public:
    ...
    const HarmonClosed &harmonClosed() const noexcept;
    void setHarmonClosed(HarmonClosed value);
    bool operator==(const HarmonMute &other) const = default;
