...
{
  public:
    const std::optional<SmuflCodaGlyphName> &smufl() const noexcept;
    void setSmufl(std::optional<SmuflCodaGlyphName> value);
    ...
    bool operator==(const Coda &other) const = default;

  private:
    std::optional<SmuflCodaGlyphName> m_smufl;
