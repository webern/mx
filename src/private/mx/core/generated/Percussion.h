...
class Percussion final
{
  public:
    ...
    const PercussionChoice &choice() const noexcept;
    void setChoice(PercussionChoice value);
    bool operator==(const Percussion &other) const = default;
