...
class Fingering final
{
  public:
    const std::optional<YesNo> &substitution() const noexcept;
    void setSubstitution(std::optional<YesNo> value);
    const std::optional<YesNo> &alternate() const noexcept;
    void setAlternate(std::optional<YesNo> value);
    ...
    bool operator==(const Fingering &other) const = default;

  private:
    std::optional<YesNo> m_substitution;
    std::optional<YesNo> m_alternate;
