...
/// standard notation and the curved bend symbols commonly used in both tablature and standard
/// notation.
...
{
  public:
    const std::optional<BendShape> &shape() const noexcept;
    void setShape(std::optional<BendShape> value);
    ...
    const Semitones &bendAlter() const noexcept;
    void setBendAlter(Semitones value);
    const std::optional<BendChoice> &choice() const noexcept;
    void setChoice(std::optional<BendChoice> value);
    const std::optional<PlacementText> &withBar() const noexcept;
    void setWithBar(std::optional<PlacementText> value);
    bool operator==(const Bend &other) const = default;

  private:
    std::optional<BendShape> m_shape;
    ...
    Semitones m_bendAlter{};
    std::optional<BendChoice> m_choice;
