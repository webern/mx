...
constexpr const char *const DOCTYPE_VALUE_SCORE_PARTWISE =
    "score-partwise PUBLIC \"-//Recordare//DTD MusicXML 3.0 Partwise//EN\" "
    "\"http://www.musicxml.org/dtds/partwise.dtd\"";
constexpr const char *const DOCTYPE_VALUE_SCORE_TIMEWISE =
    "score-timewise PUBLIC \"-//Recordare//DTD MusicXML 3.0 Timewise//EN\" "
