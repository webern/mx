...
constexpr
    ...
    : xmlVersion(kDefaultXmlVersion), documentEncoding(kDefaultDocumentEncoding), documentType(kDefaultDocumentType),
      musicXmlVersion(kDefaultMusicXmlVersion)
{
}

DocumentHeader::DocumentHeader() : mySpecs(DocumentSpecifications{})
{
}
...
DocumentHeader::DocumentHeader(const DocumentSpecifications &specs) : mySpecs(specs)
{
}
