...
{
  public:
    impl(const IntType alpha, const IntType red, const IntType green, const IntType blue)
        : myAlpha(alpha), myRed(red), myGreen(green), myBlue(blue), myColorType(Color::ColorType::ARGB)
    {
    }

    impl(const IntType red, const IntType green, const IntType blue)
        : myAlpha(255), myRed(red), myGreen(green), myBlue(blue), myColorType(Color::ColorType::RGB)
    {
    }

    impl() : myAlpha(255), myRed(255), myGreen(255), myBlue(255), myColorType(ColorType::RGB)
    {
    }
    ...
    void parse(const std::string &value)
    {
        ...
        if (value.substr(1, value.length() - 1).find_first_not_of("ABCDEF0123456789") != std::string::npos)
        {
            return; // bad input
        }
...
Color::Color(const IntType alpha, const IntType red, const IntType green, const IntType blue)
    : myImpl(new Color::impl(alpha, red, green, blue))
{
}

Color::Color(const IntType red, const IntType green, const IntType blue) : myImpl(new Color::impl(red, green, blue))
{
}

Color::Color() : myImpl(new Color::impl())
{
}

Color::Color(const std::string &value) : myImpl(new Color::impl())
{
    myImpl->parse(value);
}
...
Color::Color(const Color &other) : myImpl(new Color::impl(*other.myImpl))
{
}

Color::Color(Color &&other) : myImpl(std::move(other.myImpl))
{
}
