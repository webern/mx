...
EmptyPrintObjectStyleAlignAttributes::EmptyPrintObjectStyleAlignAttributes()
    : printObject(YesNo::yes), defaultX(0.0), defaultY(0.0), relativeX(0.0), relativeY(0.0), fontFamily(""),
      fontStyle(FontStyle::normal), fontSize(CssFontSize::medium), fontWeight(FontWeight::bold), color(255, 255, 255),
      halign(LeftCenterRight::center), valign(Valign::top), hasPrintObject(false), hasDefaultX(false),
...
bool EmptyPrintObjectStyleAlignAttributes::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
