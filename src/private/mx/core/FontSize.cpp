...
FontSize::FontSize() : myValue{Decimal{}}
{
}

FontSize::FontSize(Decimal value) : myValue{std::move(value)}
{
}

FontSize::FontSize(CssFontSize value) : myValue{value}
{
}

FontSize::FontSize(const std::string &value) : FontSize{}
{
    parse(value);
}
