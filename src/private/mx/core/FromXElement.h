...
template <typename T>
bool importElementSet(std::ostream &message, ::ezxml::XElementIterator &iter, ::ezxml::XElementIterator &endIter,
                      bool &isSuccess, const std::string &elementName, std::vector<std::shared_ptr<T>> &elementSet)
{
...
void checkSetGroupMemberAndIncrementIter(std::ostream &message, ::ezxml::XElementIterator &iter,
                                         ::ezxml::XElementIterator &endIter, bool &isSuccess,
                                         bool &hasIterBeenIncremented, std::shared_ptr<PARENT_TYPE> &elementPtr,
...
void checkSetGroupMemberSetAndIncrementIter(
    std::ostream &message, ::ezxml::XElementIterator &iter, ::ezxml::XElementIterator &endIter, bool &isSuccess,
    bool &hasIterBeenIncremented, std::string elementName, std::shared_ptr<PARENT_TYPE> &parentPtr,
...
void importGroup(std::ostream &message, ::ezxml::XElementIterator &iter, ::ezxml::XElementIterator &endIter,
                 bool &isSuccess, CreditWordsGroupPtr &group);
...
bool checkSetChoiceMember(std::ostream &message, ::ezxml::XElement &xelement, bool &isSuccess,
                          std::shared_ptr<CHOICE_CLASS_TYPE> &elementPtr, std::string choiceElementName,
                          std::shared_ptr<CHILD_TYPE> (CHOICE_CLASS_TYPE::*getFunction)() const, int choiceValue)
{
...
bool parseAttribute(std::ostream &message, ::ezxml::XAttributeIterator &iter, const std::string &className,
                    bool &isSucces, T &assignmentTarget, bool &hasAttribute, const char *const attributeName,
...
bool parseAttribute(std::ostream &message, ::ezxml::XAttributeIterator &iter, const std::string &className,
                    bool &isSucces, XsString &assignmentTarget, bool &hasAttribute, const char *const attributeName);

class Decimal;

bool parseAttribute(std::ostream &message, ::ezxml::XAttributeIterator &iter, const std::string &className,
                    bool &isSucces, Decimal &assignmentTarget, bool &hasAttribute, const char *const attributeName);

class Integer;

bool parseAttribute(std::ostream &message, ::ezxml::XAttributeIterator &iter, const std::string &className,
                    bool &isSucces, Integer &assignmentTarget, bool &hasAttribute, const char *const attributeName);

class Color;

bool parseAttribute(std::ostream &message, ::ezxml::XAttributeIterator &iter, const std::string &className,
                    bool &isSucces, Color &assignmentTarget, bool &hasAttribute, const char *const attributeName);

class Date;

bool parseAttribute(std::ostream &message, ::ezxml::XAttributeIterator &iter, const std::string &className,
                    bool &isSucces, Date &assignmentTarget, bool &hasAttribute, const char *const attributeName);

class FontSize;

bool parseAttribute(std::ostream &message, ::ezxml::XAttributeIterator &iter, const std::string &className,
                    bool &isSucces, FontSize &assignmentTarget, bool &hasAttribute, const char *const attributeName);

class NumberOrNormal;

bool parseAttribute(std::ostream &message, ::ezxml::XAttributeIterator &iter, const std::string &className,
                    bool &isSucces, NumberOrNormal &assignmentTarget, bool &hasAttribute,
                    const char *const attributeName);

class PositiveIntegerOrEmpty;

bool parseAttribute(std::ostream &message, ::ezxml::XAttributeIterator &iter, const std::string &className,
                    bool &isSucces, PositiveIntegerOrEmpty &assignmentTarget, bool &hasAttribute,
                    const char *const attributeName);

class YesNoNumber;

bool parseAttribute(std::ostream &message, ::ezxml::XAttributeIterator &iter, const std::string &className,
                    bool &isSucces, YesNoNumber &assignmentTarget, bool &hasAttribute, const char *const attributeName);

class CommaSeparatedText;

bool parseAttribute(std::ostream &message, ::ezxml::XAttributeIterator &iter, const std::string &className,
                    bool &isSucces, CommaSeparatedText &assignmentTarget, bool &hasAttribute,
                    const char *const attributeName);

class DistanceType;

bool parseAttribute(std::ostream &message, ::ezxml::XAttributeIterator &iter, const std::string &className,
                    bool &isSucces, DistanceType &assignmentTarget, bool &hasAttribute,
                    const char *const attributeName);

class LineWidthType;

bool parseAttribute(std::ostream &message, ::ezxml::XAttributeIterator &iter, const std::string &className,
                    bool &isSucces, LineWidthType &assignmentTarget, bool &hasAttribute,
                    const char *const attributeName);

class CommaSeparatedListOfPositiveIntegers;

bool parseAttribute(std::ostream &message, ::ezxml::XAttributeIterator &iter, const std::string &className,
                    bool &isSucces, CommaSeparatedListOfPositiveIntegers &assignmentTarget, bool &hasAttribute,
                    const char *const attributeName);
} // namespace core
} // namespace mx
