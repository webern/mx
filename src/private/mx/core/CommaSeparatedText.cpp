...
namespace core
{
CommaSeparatedText::CommaSeparatedText() : myValues()
{
}

CommaSeparatedText::CommaSeparatedText(const XsTokenSet &values) : myValues(values)
{
}

CommaSeparatedText::CommaSeparatedText(const StringType &value) : myValues()
{
    this->parse(value);
}
