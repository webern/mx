...
ProcessingInstruction::ProcessingInstruction() : myName{"default-name"}, myData{}, mIsChild{true}
{
}

ProcessingInstruction::ProcessingInstruction(StringType inName, StringType inData) : ProcessingInstruction{}
{
