...
Document::Document()
    : myChoice(DEFAULT_DOCUMENT_CHOICE), myScorePartwise(makeScorePartwise()), myScoreTimewise(makeScoreTimewise())
{
}

Document::Document(DocumentChoice choice)
    : myChoice(choice), myScorePartwise(makeScorePartwise()), myScoreTimewise(makeScoreTimewise())
{
}
