...
namespace core
{
Grouping::Grouping() : myAttributes(std::make_shared<GroupingAttributes>()), myFeatureSet()
{
}
...
bool Grouping::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    bool isSuccess = true;
