...
namespace core
{
KeyStep::KeyStep() : myValue(StepEnum::a)
{
}

KeyStep::KeyStep(const StepEnum &value) : myValue(value)
{
}
...
bool KeyStep::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    MX_UNUSED(message);
    MX_UNUSED(xelement);
