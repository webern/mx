...
inline KindPtr makeKind()
{
    return std::make_shared<Kind>();
}

inline KindPtr makeKind(const KindValue &value)
{
    return std::make_shared<Kind>(value);
}

inline KindPtr makeKind(KindValue &&value)
{
    return std::make_shared<Kind>(std::move(value));
}
