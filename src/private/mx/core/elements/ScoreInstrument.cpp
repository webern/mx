...
bool ScoreInstrument::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    bool isSuccess = true;
    ...
    {
        if (importElement(message, *it, isSuccess, *myInstrumentName, isInstrumentNameFound))
        {
            continue;
        }
        if (importElement(message, *it, isSuccess, *myInstrumentAbbreviation, myHasInstrumentAbbreviation))
        {
            continue;
        }
        if (importElement(message, *it, isSuccess, *myInstrumentSound, myHasInstrumentSound))
        {
            continue;
        }
