...
inline DynamicsPtr makeDynamics()
{
    return std::make_shared<Dynamics>();
}

inline DynamicsPtr makeDynamics(const DynamicsValue &value)
{
    return std::make_shared<Dynamics>(value);
}

inline DynamicsPtr makeDynamics(DynamicsValue &&value)
{
    return std::make_shared<Dynamics>(std::move(value));
}
