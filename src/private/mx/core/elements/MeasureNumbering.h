...
inline MeasureNumberingPtr makeMeasureNumbering()
{
    return std::make_shared<MeasureNumbering>();
}

inline MeasureNumberingPtr makeMeasureNumbering(const MeasureNumberingValue &value)
{
    return std::make_shared<MeasureNumbering>(value);
}

inline MeasureNumberingPtr makeMeasureNumbering(MeasureNumberingValue &&value)
{
    return std::make_shared<MeasureNumbering>(std::move(value));
}
