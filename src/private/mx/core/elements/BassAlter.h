...
inline BassAlterPtr makeBassAlter()
{
    return std::make_shared<BassAlter>();
}

inline BassAlterPtr makeBassAlter(const Semitones &value)
{
    return std::make_shared<BassAlter>(value);
}

inline BassAlterPtr makeBassAlter(Semitones &&value)
{
    return std::make_shared<BassAlter>(std::move(value));
}
