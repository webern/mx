...
class Key : public ElementInterface
{
  ...
  private:
    ...
    bool importTraditionalKey(std::ostream &message, ::ezxml::XElementIterator &iter,
                              ::ezxml::XElementIterator &endIter, bool &isSuccess);
    bool importNonTraditionalKey(std::ostream &message, ::ezxml::XElementIterator &iter,
                                 ::ezxml::XElementIterator &endIter, bool &isSuccess);
};
} // namespace core
} // namespace mx
