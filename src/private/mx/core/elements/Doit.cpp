...
namespace core
{
Doit::Doit() : ElementInterface(), myAttributes(std::make_shared<EmptyLineAttributes>())
{
}
...
std::ostream &Doit::streamName(std::ostream &os) const
{
    os << "doit";
    return os;
}
