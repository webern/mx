...
namespace core
{
TupletDot::TupletDot() : ElementInterface(), myAttributes(std::make_shared<TupletDotAttributes>())
{
}
...
bool TupletDot::hasContents() const
{
    return false;
}
...
std::ostream &TupletDot::streamName(std::ostream &os) const
{
    os << "tuplet-dot";
    return os;
}
...
bool TupletDot::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
