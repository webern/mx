...
namespace core
{
LyricFont::LyricFont() : ElementInterface(), myAttributes(std::make_shared<LyricFontAttributes>())
{
}
...
bool LyricFont::hasContents() const
{
    return false;
}
...
std::ostream &LyricFont::streamName(std::ostream &os) const
{
    os << "lyric-font";
    return os;
}
...
bool LyricFont::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
