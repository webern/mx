...
BracketAttributes::BracketAttributes()
    : type(), number(), lineEnd(LineEnd::down), endLength(), lineType(), dashLength(), spaceLength(), defaultX(),
      defaultY(), relativeX(), relativeY(), color(), hasType(true), hasNumber(false), hasLineEnd(true),
      hasEndLength(false), hasLineType(false), hasDashLength(false), hasSpaceLength(false), hasDefaultX(false),
