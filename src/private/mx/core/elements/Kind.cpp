...
namespace core
{
Kind::Kind() : myValue(KindValue::none), myAttributes(std::make_shared<KindAttributes>())
{
}

Kind::Kind(const KindValue &value) : myValue(value), myAttributes(std::make_shared<KindAttributes>())
{
}
