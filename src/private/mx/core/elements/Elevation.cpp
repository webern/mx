...
namespace core
{
Elevation::Elevation() : myValue()
{
}

Elevation::Elevation(const RotationDegrees &value) : myValue(value)
{
}
...
bool Elevation::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    MX_UNUSED(message);
    MX_UNUSED(xelement);
