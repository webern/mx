...
inline NoteSizePtr makeNoteSize()
{
    return std::make_shared<NoteSize>();
}

inline NoteSizePtr makeNoteSize(const NonNegativeDecimal &value)
{
    return std::make_shared<NoteSize>(value);
}

inline NoteSizePtr makeNoteSize(NonNegativeDecimal &&value)
{
    return std::make_shared<NoteSize>(std::move(value));
}
