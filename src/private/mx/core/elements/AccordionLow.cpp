...
bool AccordionLow::hasAttributes() const
{
    return false;
}

bool AccordionLow::hasContents() const
{
    return false;
}

std::ostream &AccordionLow::streamAttributes(std::ostream &os) const
{
    return os;
}

std::ostream &AccordionLow::streamName(std::ostream &os) const
{
    os << "accordion-low";
    return os;
}
