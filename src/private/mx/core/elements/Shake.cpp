...
namespace core
{
Shake::Shake() : ElementInterface(), myAttributes(std::make_shared<EmptyTrillSoundAttributes>())
{
}
...
std::ostream &Shake::streamName(std::ostream &os) const
{
    os << "shake";
    return os;
}
