...
inline BeaterPtr makeBeater()
{
    return std::make_shared<Beater>();
}

inline BeaterPtr makeBeater(const BeaterValue &value)
{
    return std::make_shared<Beater>(value);
}

inline BeaterPtr makeBeater(BeaterValue &&value)
{
    return std::make_shared<Beater>(std::move(value));
}
