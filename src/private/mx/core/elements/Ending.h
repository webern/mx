...
inline EndingPtr makeEnding()
{
    return std::make_shared<Ending>();
}

inline EndingPtr makeEnding(const XsString &value)
{
    return std::make_shared<Ending>(value);
}

inline EndingPtr makeEnding(XsString &&value)
{
    return std::make_shared<Ending>(std::move(value));
}
