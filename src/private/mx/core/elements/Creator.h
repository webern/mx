...
inline CreatorPtr makeCreator()
{
    return std::make_shared<Creator>();
}

inline CreatorPtr makeCreator(const XsString &value)
{
    return std::make_shared<Creator>(value);
}

inline CreatorPtr makeCreator(XsString &&value)
{
    return std::make_shared<Creator>(std::move(value));
}
