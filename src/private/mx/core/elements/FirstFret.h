...
inline FirstFretPtr makeFirstFret()
{
    return std::make_shared<FirstFret>();
}

inline FirstFretPtr makeFirstFret(const PositiveInteger &value)
{
    return std::make_shared<FirstFret>(value);
}

inline FirstFretPtr makeFirstFret(PositiveInteger &&value)
{
    return std::make_shared<FirstFret>(std::move(value));
}
