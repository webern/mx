...
namespace core
{
Staves::Staves() : myValue()
{
}

Staves::Staves(const NonNegativeInteger &value) : myValue(value)
{
}
...
bool Staves::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    MX_UNUSED(message);
    MX_UNUSED(xelement);
