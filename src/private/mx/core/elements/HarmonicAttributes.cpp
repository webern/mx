...
HarmonicAttributes::HarmonicAttributes()
    : printObject(YesNo::no), defaultX(), defaultY(), relativeX(), relativeY(), fontFamily(),
      ...
      placement(AboveBelow::below), hasPrintObject(false), hasDefaultX(false), hasDefaultY(false), hasRelativeX(false),
...
bool HarmonicAttributes::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
