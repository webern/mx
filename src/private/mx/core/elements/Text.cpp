...
namespace core
{
Text::Text() : myValue(), myAttributes(std::make_shared<TextAttributes>())
{
}

Text::Text(const XsString &value) : myValue(value), myAttributes(std::make_shared<TextAttributes>())
{
}
...
bool Text::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    bool isSuccess = true;
