...
namespace core
{
Software::Software() : myValue()
{
}

Software::Software(const XsString &value) : myValue(value)
{
}
...
bool Software::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    MX_UNUSED(message);
    MX_UNUSED(xelement);
