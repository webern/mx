...
namespace core
{
Image::Image() : ElementInterface(), myAttributes(std::make_shared<ImageAttributes>())
{
}
...
std::ostream &Image::streamName(std::ostream &os) const
{
    os << "image";
    return os;
}
...
bool Image::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
