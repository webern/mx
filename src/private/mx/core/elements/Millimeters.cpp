...
namespace core
{
Millimeters::Millimeters() : myValue()
{
}

Millimeters::Millimeters(const MillimetersValue &value) : myValue(value)
{
}
...
bool Millimeters::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    MX_UNUSED(message);
    MX_UNUSED(xelement);
