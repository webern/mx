...
inline OtherPlayPtr makeOtherPlay()
{
    return std::make_shared<OtherPlay>();
}

inline OtherPlayPtr makeOtherPlay(const XsString &value)
{
    return std::make_shared<OtherPlay>(value);
}

inline OtherPlayPtr makeOtherPlay(XsString &&value)
{
    return std::make_shared<OtherPlay>(std::move(value));
}
