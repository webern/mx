...
inline ScorePartPtr makeScorePart()
{
    return std::make_shared<ScorePart>();
}
...
class ScorePart : public ElementInterface
{
  public:
    ...
    MidiDeviceInstrumentGroupPtr getMidiDeviceInstrumentGroup(
  ...
  private:
    ...
    void importMidiDeviceInstrumentGroupSet(std::ostream &message, ::ezxml::XElementIterator &iter,
