...
inline FootnotePtr makeFootnote()
{
    return std::make_shared<Footnote>();
}

inline FootnotePtr makeFootnote(const XsString &value)
{
    return std::make_shared<Footnote>(value);
}

inline FootnotePtr makeFootnote(XsString &&value)
{
    return std::make_shared<Footnote>(std::move(value));
}
