...
inline StaffPtr makeStaff()
{
    return std::make_shared<Staff>();
}

inline StaffPtr makeStaff(const PositiveInteger &value)
{
    return std::make_shared<Staff>(value);
}

inline StaffPtr makeStaff(PositiveInteger &&value)
{
    return std::make_shared<Staff>(std::move(value));
}
