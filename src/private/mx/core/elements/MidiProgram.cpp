...
namespace core
{
MidiProgram::MidiProgram() : myValue()
{
}

MidiProgram::MidiProgram(const Midi128 &value) : myValue(value)
{
}
...
bool MidiProgram::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    MX_UNUSED(message);
    MX_UNUSED(xelement);
