...
namespace core
{
MeasureLayout::MeasureLayout() : myMeasureDistance(makeMeasureDistance()), myHasMeasureDistance(false)
{
}
...
bool MeasureLayout::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    ...
    {
        if (importElement(message, *it, isSuccess, *myMeasureDistance, myHasMeasureDistance))
        {
            continue;
        }
    }
