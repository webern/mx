...
namespace core
{
StaffSize::StaffSize() : myValue()
{
}

StaffSize::StaffSize(const NonNegativeDecimal &value) : myValue(value)
{
}
...
bool StaffSize::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    MX_UNUSED(message);
    MX_UNUSED(xelement);
