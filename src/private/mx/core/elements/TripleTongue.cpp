...
namespace core
{
TripleTongue::TripleTongue() : ElementInterface(), myAttributes(std::make_shared<EmptyPlacementAttributes>())
{
}
...
bool TripleTongue::hasContents() const
{
    return false;
}
...
std::ostream &TripleTongue::streamName(std::ostream &os) const
{
    os << "triple-tongue";
    return os;
}
