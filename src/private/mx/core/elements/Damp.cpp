...
namespace core
{
Damp::Damp() : ElementInterface(), myAttributes(std::make_shared<EmptyPrintObjectStyleAlignAttributes>())
{
}
...
std::ostream &Damp::streamName(std::ostream &os) const
{
    os << "damp";
    return os;
}
...
bool Damp::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
