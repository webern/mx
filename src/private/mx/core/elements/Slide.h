...
inline SlidePtr makeSlide()
{
    return std::make_shared<Slide>();
}

inline SlidePtr makeSlide(const XsString &value)
{
    return std::make_shared<Slide>(value);
}

inline SlidePtr makeSlide(XsString &&value)
{
    return std::make_shared<Slide>(std::move(value));
}
