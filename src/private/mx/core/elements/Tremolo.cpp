...
namespace core
{
Tremolo::Tremolo() : myValue(3), myAttributes(std::make_shared<TremoloAttributes>())
{
}

Tremolo::Tremolo(const TremoloMarks &value) : myValue(value), myAttributes(std::make_shared<TremoloAttributes>())
{
}
...
bool Tremolo::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    bool isSuccess = true;
