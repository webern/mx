...
namespace core
{
SlashType::SlashType() : myValue(NoteTypeValue::eighth)
{
}

SlashType::SlashType(const NoteTypeValue &value) : myValue(value)
{
}
...
bool SlashType::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    MX_UNUSED(message);
