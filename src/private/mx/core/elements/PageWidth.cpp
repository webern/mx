...
namespace core
{
PageWidth::PageWidth() : myValue()
{
}

PageWidth::PageWidth(const TenthsValue &value) : myValue(value)
{
}
...
bool PageWidth::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    MX_UNUSED(message);
    MX_UNUSED(xelement);
