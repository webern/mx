...
inline OtherArticulationPtr makeOtherArticulation()
{
    return std::make_shared<OtherArticulation>();
}

inline OtherArticulationPtr makeOtherArticulation(const XsString &value)
{
    return std::make_shared<OtherArticulation>(value);
}

inline OtherArticulationPtr makeOtherArticulation(XsString &&value)
{
    return std::make_shared<OtherArticulation>(std::move(value));
}
