...
EditorialVoiceDirectionGroup::EditorialVoiceDirectionGroup()
    : myFootnote(makeFootnote()), myHasFootnote(false), myLevel(makeLevel()), myHasLevel(false), myVoice(makeVoice()),
      myHasVoice(false)
{
}
...
std::ostream &EditorialVoiceDirectionGroup::streamContents(std::ostream &os, const int indentLevel,
