...
namespace core
{
Tap::Tap() : myValue(), myAttributes(std::make_shared<TapAttributes>())
{
}

Tap::Tap(const XsString &value) : myValue(value), myAttributes(std::make_shared<TapAttributes>())
{
}
...
bool Tap::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    bool isSuccess = true;
