...
namespace core
{
OtherNotation::OtherNotation() : myValue(), myAttributes(std::make_shared<OtherNotationAttributes>())
{
}

OtherNotation::OtherNotation(const XsString &value)
    : myValue(value), myAttributes(std::make_shared<OtherNotationAttributes>())
{
}
...
bool OtherNotation::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    bool isSuccess = true;
