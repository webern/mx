...
namespace core
{
BendAlter::BendAlter() : myValue()
{
}

BendAlter::BendAlter(const Semitones &value) : myValue(value)
{
}
...
bool BendAlter::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    MX_UNUSED(message);
    MX_UNUSED(xelement);
