...
namespace core
{
ArrowStyle::ArrowStyle() : myValue(ArrowStyleEnum::single)
{
}

ArrowStyle::ArrowStyle(const ArrowStyleEnum &value) : myValue(value)
{
}
...
bool ArrowStyle::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    MX_UNUSED(message);
