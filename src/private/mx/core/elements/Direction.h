...
inline DirectionPtr makeDirection()
{
...
class Direction : public ElementInterface
{
  ...
  private:
    ...
    bool importDirectionTypeSet(std::ostream &message, ::ezxml::XElementIterator &iter,
                                ::ezxml::XElementIterator &endIter, bool &isSuccess, bool &isFound);
    DirectionTypePtr createDirectionType(std::ostream &message, ::ezxml::XElementIterator &iter,
