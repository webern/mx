...
LyricFontAttributes::LyricFontAttributes()
    : number(), name(), fontFamily(), fontStyle(FontStyle::normal), fontSize(CssFontSize::medium),
      fontWeight(FontWeight::normal), hasNumber(false), hasName(false), hasFontFamily(false), hasFontStyle(false),
...
{
    return hasNumber || hasName || hasFontFamily || hasFontStyle || hasFontSize || hasFontWeight;
}
