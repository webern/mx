...
namespace core
{
Tie::Tie() : ElementInterface(), myAttributes(std::make_shared<TieAttributes>())
{
}
...
std::ostream &Tie::streamName(std::ostream &os) const
{
    os << "tie";
    return os;
}
...
bool Tie::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
