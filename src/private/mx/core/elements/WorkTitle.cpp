...
namespace core
{
WorkTitle::WorkTitle() : myValue()
{
}

WorkTitle::WorkTitle(const XsString &value) : myValue(value)
{
}
...
bool WorkTitle::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    MX_UNUSED(message);
    MX_UNUSED(xelement);
