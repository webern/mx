...
namespace core
{
Barre::Barre() : ElementInterface(), myAttributes(std::make_shared<BarreAttributes>())
{
}
...
std::ostream &Barre::streamName(std::ostream &os) const
{
    os << "barre";
    return os;
}
