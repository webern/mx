...
namespace core
{
Instrument::Instrument() : ElementInterface(), myAttributes(std::make_shared<InstrumentAttributes>())
{
}
...
bool Instrument::hasContents() const
{
    return false;
}
...
std::ostream &Instrument::streamName(std::ostream &os) const
{
    os << "instrument";
    return os;
}
...
bool Instrument::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
