...
namespace core
{
WordFont::WordFont() : ElementInterface(), myAttributes(std::make_shared<EmptyFontAttributes>())
{
}
...
bool WordFont::hasContents() const
{
    return false;
}
...
std::ostream &WordFont::streamName(std::ostream &os) const
{
    os << "word-font";
    return os;
}
