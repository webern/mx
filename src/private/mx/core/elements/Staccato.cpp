...
namespace core
{
Staccato::Staccato() : ElementInterface(), myAttributes(std::make_shared<EmptyPlacementAttributes>())
{
}
...
bool Staccato::hasContents() const
{
    return false;
}
...
std::ostream &Staccato::streamName(std::ostream &os) const
{
    os << "staccato";
    return os;
}
...
bool Staccato::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
