...
inline AccidentalTextPtr makeAccidentalText()
{
    return std::make_shared<AccidentalText>();
}

inline AccidentalTextPtr makeAccidentalText(const AccidentalValue &value)
{
    return std::make_shared<AccidentalText>(value);
}

inline AccidentalTextPtr makeAccidentalText(AccidentalValue &&value)
{
    return std::make_shared<AccidentalText>(std::move(value));
}
