...
inline TupletTypePtr makeTupletType()
{
    return std::make_shared<TupletType>();
}

inline TupletTypePtr makeTupletType(const NoteTypeValue &value)
{
    return std::make_shared<TupletType>(value);
}

inline TupletTypePtr makeTupletType(NoteTypeValue &&value)
{
    return std::make_shared<TupletType>(std::move(value));
}
