...
namespace core
{
EncodingDate::EncodingDate() : myValue()
{
}

EncodingDate::EncodingDate(const Date &value) : myValue(value)
{
}
...
bool EncodingDate::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    MX_UNUSED(message);
    MX_UNUSED(xelement);
