...
inline MeasureRepeatPtr makeMeasureRepeat()
{
    return std::make_shared<MeasureRepeat>();
}

inline MeasureRepeatPtr makeMeasureRepeat(const PositiveIntegerOrEmpty &value)
{
    return std::make_shared<MeasureRepeat>(value);
}

inline MeasureRepeatPtr makeMeasureRepeat(PositiveIntegerOrEmpty &&value)
{
    return std::make_shared<MeasureRepeat>(std::move(value));
}
