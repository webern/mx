...
inline WordsPtr makeWords()
{
    return std::make_shared<Words>();
}

inline WordsPtr makeWords(const XsString &value)
{
    return std::make_shared<Words>(value);
}

inline WordsPtr makeWords(XsString &&value)
{
    return std::make_shared<Words>(std::move(value));
}
