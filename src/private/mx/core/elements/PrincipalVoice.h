...
inline PrincipalVoicePtr makePrincipalVoice()
{
    return std::make_shared<PrincipalVoice>();
}

inline PrincipalVoicePtr makePrincipalVoice(const XsString &value)
{
    return std::make_shared<PrincipalVoice>(value);
}

inline PrincipalVoicePtr makePrincipalVoice(XsString &&value)
{
    return std::make_shared<PrincipalVoice>(std::move(value));
}
