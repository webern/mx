...
namespace core
{
DisplayOctave::DisplayOctave() : myValue()
{
}

DisplayOctave::DisplayOctave(const OctaveValue &value) : myValue(value)
{
}
...
bool DisplayOctave::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    MX_UNUSED(message);
    MX_UNUSED(xelement);
