...
namespace core
{
Rehearsal::Rehearsal() : myValue(), myAttributes(std::make_shared<RehearsalAttributes>())
{
}

Rehearsal::Rehearsal(const XsString &value) : myValue(value), myAttributes(std::make_shared<RehearsalAttributes>())
{
}
...
bool Rehearsal::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    bool isSuccess = true;
