...
namespace core
{
PageHeight::PageHeight() : myValue()
{
}

PageHeight::PageHeight(const TenthsValue &value) : myValue(value)
{
}
...
bool PageHeight::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    MX_UNUSED(message);
    MX_UNUSED(xelement);
