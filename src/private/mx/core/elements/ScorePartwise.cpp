...
ScorePartwise::ScorePartwise()
    : myAttributes(std::make_shared<ScorePartwiseAttributes>()), myScoreHeaderGroup(makeScoreHeaderGroup()),
      myPartwisePartSet()
{
...
bool ScorePartwise::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    bool isSuccess = true;
