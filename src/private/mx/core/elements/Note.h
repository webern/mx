...
class Note : public ElementInterface
{
  ...
  private:
    ...
    bool parseNoteChoice(std::ostream &message, ::ezxml::XElement &noteElement, ::ezxml::XElementIterator &iter);

    bool parseFullNoteGroup(std::ostream &message, ::ezxml::XElement &noteElement, ::ezxml::XElementIterator &iter,
                            FullNoteGroupPtr &outFullNoteGroup);

    bool parseEditorialVoiceGroup(std::ostream &message, ::ezxml::XElement &noteElement,
