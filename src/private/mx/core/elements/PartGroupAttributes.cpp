...
PartGroupAttributes::PartGroupAttributes()
    : type(StartStop::start), number(XsToken("1")), hasType(true), hasNumber(false)
{
}
...
bool PartGroupAttributes::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
