...
namespace core
{
StaffLayoutAttributes::StaffLayoutAttributes() : number(), hasNumber(false)
{
}
...
bool StaffLayoutAttributes::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
