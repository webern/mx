...
namespace core
{
MidiDevice::MidiDevice() : myValue(), myAttributes(std::make_shared<MidiDeviceAttributes>())
{
}

MidiDevice::MidiDevice(const XsString &value) : myValue(value), myAttributes(std::make_shared<MidiDeviceAttributes>())
{
}
...
bool MidiDevice::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    bool isSuccess = true;
