...
namespace core
{
TuningOctave::TuningOctave() : myValue()
{
}

TuningOctave::TuningOctave(const OctaveValue &value) : myValue(value)
{
}
...
bool TuningOctave::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    MX_UNUSED(message);
    MX_UNUSED(xelement);
