...
namespace core
{
TuningAlter::TuningAlter() : myValue()
{
}

TuningAlter::TuningAlter(const Semitones &value) : myValue(value)
{
}
...
bool TuningAlter::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    MX_UNUSED(message);
    MX_UNUSED(xelement);
