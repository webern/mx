...
namespace core
{
BassStep::BassStep() : myValue(StepEnum::a), myAttributes(std::make_shared<BassStepAttributes>())
{
}

BassStep::BassStep(const StepEnum &value) : myValue(value), myAttributes(std::make_shared<BassStepAttributes>())
{
}
...
bool BassStep::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    bool isSuccess = true;
