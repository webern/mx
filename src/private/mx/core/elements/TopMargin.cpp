...
namespace core
{
TopMargin::TopMargin() : myValue()
{
}

TopMargin::TopMargin(const TenthsValue &value) : myValue(value)
{
}
...
bool TopMargin::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    MX_UNUSED(message);
    MX_UNUSED(xelement);
