...
namespace core
{
LeftDivider::LeftDivider() : ElementInterface(), myAttributes(std::make_shared<EmptyPrintObjectStyleAlignAttributes>())
{
}
...
bool LeftDivider::hasContents() const
{
    return false;
}
...
std::ostream &LeftDivider::streamName(std::ostream &os) const
{
    os << "left-divider";
    return os;
}
...
bool LeftDivider::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
