...
bool MetronomeAttributes::hasValues() const
{
    return hasDefaultX || hasDefaultY || hasRelativeX || hasRelativeY || hasFontFamily || hasFontStyle || hasFontSize ||
           hasFontWeight || hasColor || hasHalign || hasValign || hasJustify || hasParentheses;
}
...
bool MetronomeAttributes::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
