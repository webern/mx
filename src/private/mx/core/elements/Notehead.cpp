...
namespace core
{
Notehead::Notehead() : myValue(NoteheadValue::normal), myAttributes(std::make_shared<NoteheadAttributes>())
{
}

Notehead::Notehead(const NoteheadValue &value) : myValue(value), myAttributes(std::make_shared<NoteheadAttributes>())
{
}
...
bool Notehead::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
    bool isSuccess = true;
