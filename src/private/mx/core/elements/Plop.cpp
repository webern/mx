...
namespace core
{
Plop::Plop() : ElementInterface(), myAttributes(std::make_shared<EmptyLineAttributes>())
{
}
...
std::ostream &Plop::streamName(std::ostream &os) const
{
    os << "plop";
    return os;
}
