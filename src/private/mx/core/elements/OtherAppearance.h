...
inline OtherAppearancePtr makeOtherAppearance()
{
    return std::make_shared<OtherAppearance>();
}

inline OtherAppearancePtr makeOtherAppearance(const XsString &value)
{
    return std::make_shared<OtherAppearance>(value);
}

inline OtherAppearancePtr makeOtherAppearance(XsString &&value)
{
    return std::make_shared<OtherAppearance>(std::move(value));
}
