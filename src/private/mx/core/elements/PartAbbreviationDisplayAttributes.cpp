...
namespace core
{
PartAbbreviationDisplayAttributes::PartAbbreviationDisplayAttributes() : printObject(YesNo::no), hasPrintObject(false)
{
}
...
bool PartAbbreviationDisplayAttributes::fromXElementImpl(std::ostream &message, ::ezxml::XElement &xelement)
{
