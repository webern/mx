...
namespace core
{
Bracket::Bracket() : ElementInterface(), myAttributes(std::make_shared<BracketAttributes>())
{
}
...
bool Bracket::hasContents() const
{
    return false;
}
...
std::ostream &Bracket::streamName(std::ostream &os) const
{
    os << "bracket";
    return os;
}
