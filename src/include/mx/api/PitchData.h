...
struct PitchData
{
    ...
    constexpr explicit PitchData(Step inStep, int inAlter = 0, int inOctave = 4,
                                 Accidental inAccidental = Accidental::none,

                                 // less-often used params last
                                 double inCents = 0.0, bool inIsAccidentalParenthetical = false,
                                 bool inIsAccidentalCautionary = false, bool inIsAccidentalEditorial = false,
                                 bool inIsAccidentalBracketed = false)
        : step{inStep}, alter{inAlter}, cents{inCents}, accidental{inAccidental},
          isAccidentalParenthetical{inIsAccidentalParenthetical}, isAccidentalCautionary{inIsAccidentalCautionary},
          isAccidentalEditorial{inIsAccidentalEditorial}, isAccidentalBracketed{inIsAccidentalBracketed},
          octave{inOctave}
    {
    }
